...
| NFV-12 | Preparation and Start UI | `DONE` | Live Share prepares a fresh room without capture, presence or approval. Copy Invite, Join an Invite, New Room, optional Access Word, Live Friends and Start Sharing precede Sources, Settings, Viewers and Statistics; zero-source Start has an explicit waiting state. |
